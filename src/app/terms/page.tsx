...
export default function TermsOfUse() {
  return (
    <div className="flex min-h-screen w-full flex-col items-center font-sans">
      <main className="flex min-h-screen w-full flex-col items-center pt-20 md:pt-32 pb-20">
        <div className="w-full max-w-4xl px-4 md:px-6 flex flex-col items-center">
          ...
          <div className="glass-card p-6 md:p-10 rounded-2xl border border-slate-700 w-full shadow-2xl">
            <h1 className="text-3xl md:text-5xl font-bold text-text-neon neon-text mb-8 text-center uppercase tracking-tighter">
              Terms of Use
            </h1>
